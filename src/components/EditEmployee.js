    ...
    return (
        <>
            ...
            >
                ...
                <Modal.Body>
                    <form onSubmit={(e) => { handleClose(); e.preventDefault(); props.updatedEmployees(props.id, name, role) }} id="editModel" className="w-full max-w-sm">
                ...
                <Modal.Footer>
                    ...
                    <button form="editModel" className="shadow bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" >
                        Update
                    </button>
